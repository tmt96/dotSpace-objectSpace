...
namespace dotSpace.BaseClasses.Network
{
    ...
    /// The ObjectRepositoryBase class allows direct access to the contained spaces through their respective identifies.
    ...
    public abstract class ObjectRepositoryBase : IObjectRepositorySimple
    {
        ...
        /// <summary>
        /// Retrieves and removes the first object from the target Space, matching the specified type. The operation will block if no elements match.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves and removes the first object from the target Space, matching the specified type. The operation is non-blocking. The operation will return null if no elements match.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves and removes all objects from the target Space matching the specified type. The operation is non-blocking. The operation will return an empty set if no elements match.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves the first object from the target Space, matching the specified type. The operation will block if no elements match.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves the first object from the target Space, matching the specified type. The operation is non-blocking. The operation will return null if no elements match.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves all objects from the target Space matching the specified type. The operation is non-blocking. The operation will return an empty set if no elements match.
        /// </summary>
        ...
        /// <summary>
        /// Inserts the object passed as argument into the target Space.
        /// </summary>
